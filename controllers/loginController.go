           ...
           //Check Available Account
            ...
            if err != nil {
             ...
             //Check Status Account
                ...
                if  w.NamaTravel.Valid == false && w.Phone == "" && w.Fax == "" && w.Mobile.Valid == false && w.AlamatKantor == "" && w.KotaKantor == "" && w.Provinsi == "" && w.NoKemenagUmroh.Valid == false && w.KemenangUmrohPath.Valid == false && w.NoKemenangHaji.Valid == false && w.KemenagHajiPath.Valid == false {
